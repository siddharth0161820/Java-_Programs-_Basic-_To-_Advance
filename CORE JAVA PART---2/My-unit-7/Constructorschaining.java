...
/////UNDERSTANDING PARAMETERIZED CONSTRUCTORS/////////----------------------1
 Constructorschaining(String color, int maxSpeed){ //constructor name should be same as class name 
...
//metod 0
public Constructorschaining Start(){ 
   //public void Start(){
...
public class Driver{
    public static void main(String[] args) {
     ...
     //  declaring object for the class constructorstypes with color of the constructortypes-----------2
        Constructorschaining myConstructorschaining=new Constructorschaining("REDISHH",33); //syntax for declaring object
     ...
     Constructorschaining myConstructorschaining1=new Constructorschaining(); //syntax for declaring object---constructor 1 with no argument
    
        myConstructorschaining.Start().Drive();
        System.out.println(myConstructorschaining.color);//ye jake direct constrctor ko call krke result dega--constructor with 2 argument
        System.out.println(myConstructorschaining.maxSpeed);
           System.out.println(myConstructorschaining1.color);
           System.out.println(myConstructorschaining1.maxSpeed);
           System.out.println(myConstructorschaining1.currentFuelInLitres);
